  ...
  return ( 
    <footer>
        ...
        <ListadoRedes>
            ...
            <li>
              <img src={redesIconos[2].node.publicURL} alt="icono facebook"/>
            </li>
            <li>
              <img src={redesIconos[1].node.publicURL} alt="icono instagram" />
            </li>
            <li>
              <img src={redesIconos[0].node.publicURL} alt="icono linkedin" />
            </li>
